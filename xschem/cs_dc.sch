...
S {}
E {}
B 2 800 -490 1600 -90 {flags=graph
y1=0
y2=2
ypos1=0
ypos2=2
...
C {devices/code.sym} 560 -280 0 0 {name=TT_MODELS
only_toplevel=true
...
"
spice_ignore=false}
C {devices/code_shown.sym} 530 -560 0 0 {name=s1 only_toplevel=false value=
"
.control
  save all
  op
...
C {devices/launcher.sym} 860 -60 0 0 {name=h5
descr="load waves" 
tclcommand="xschem raw_read $netlist_dir/cs_dc.raw dc"
}
